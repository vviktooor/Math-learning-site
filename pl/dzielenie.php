...
<div class="banner">
        ...
        <div class="language">
            <a href="dzielenie.php"><img src="../img/poland.png" alt=""></a>
            <a href="../en/dzielenie_en.php"><img src="../img/united-kingdom.png" alt=""></a>
        </div>
    </div>
    ...
    <section class="glowny">
        ...
        <script>
            ...
            if(l_zadan == 10|| l_zadan > 10){
                ...
                ddocument.getElementById("start").style.display = "none";
